...
#define _LANGUAGE_EN_H_
    ...
    #define EN_BLTOUCH              "Laser Off"
    #define EN_BLTOUCH_TEST         "2% Laser"
    #define EN_BLTOUCH_DEPLOY       "Zero X"
    #define EN_BLTOUCH_STOW         "Zero Y"
    #define EN_BLTOUCH_REPEAT       "Zero Z"
    #define EN_PROBE_OFFSET         "Zero All"
